...
plt.subplot(2,3,4),plt.imshow(img3),plt.title('direct addition')
plt.subplot(2,3,5),plt.imshow(img4),plt.title('overlap addition')
...
#plt.subplot(2,3,6),plt.imshow(bimg2,'gray'),plt.title('inv binary img')
plt.show()
